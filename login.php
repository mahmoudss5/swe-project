...
<div class="login-container" id="loginForm" lang="en" dir="ltr">
  ...
  <form action="loginF.php"  method="post">
    ...
    <div class="text-center mt-3">
      <small id="signupText">Don't have an account? <a href="#">Sign up</a></small>
    </div>
  </form>
</div>
...
<script>
  ...
  function toggleLang() {
    ...
    document.getElementById('signupText').innerHTML = isArabic ? 'ليس لديك حساب؟ <a href="#">إنشاء حساب</a>' : "Don't have an account? <a href='#'>Sign up</a>";
  }
</script>
